...
### APE
**Automatic Prompt Engineer (APE)**​ 是一种自动化生成和选择提示（prompts）的系统，由 Zhou 等人提出。其灵感来源于**经典程序合成**和**人工提示工程方法**，旨在为特定任务自动生成有效的提示，从而简化提示工程的过程。以下是对 APE 的详细介绍，包括其核心思想、实现方式以及与相关工作的对比。
